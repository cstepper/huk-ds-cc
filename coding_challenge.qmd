...
#| label: eda-claim
#| code-fold: true
#| fig-cap: Claim amounts per exposure (on log10-transformed axis). (a) density plot. (c) descending ecdf in log-log.
...
```{r}
#| label: corr-pred-res
#| fig-cap: Distribution of variables for each VehBrand.
#| fig-height: 10
#| fig-width: 8
#| code-fold: true
#| message: false
...
For comparing the models WRT to performance, 
